...
Провести RFM-анализ клиентской базы и дать рекомендации по повышению эффективности SMS-рассылки.
...
Прибыль, полученную от привлечения клиента, мы можем увеличить за счет рассылки SMS с разным содержанием для разных категорий клиентов, тем самым повышая конверсию в продажи.  
...
![recency_dist](assets/recency_dist.png)
...
![frequency_groups](assets/frequency_groups.png)
...
![monetary_dist](assets/monetary_dist.png)
...
![purchases_and_regs)](assets/purchases_and_regs.png)
